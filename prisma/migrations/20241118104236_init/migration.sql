...
CREATE TABLE "Question" (
    ...
    "questionAcceptance" DOUBLE PRECISION NOT NULL,
...
-- AddForeignKey
ALTER TABLE "QuestionCompany" ADD CONSTRAINT "QuestionCompany_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "Question"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
